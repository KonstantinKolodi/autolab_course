...
class CarNavigationNode(Node): 
    ...
    def setup_initial_pose(self): 
        ...
        initial_pose.pose.pose.position.x = 3772.32
        initial_pose.pose.pose.position.y = 73799.5
        initial_pose.pose.pose.orientation.z = 0.221474
        initial_pose.pose.pose.orientation.w = 0.975166
        time.sleep(10)
        self.initial_pose_publisher.publish(initial_pose) 
        
    def setup_goals(self): 
        self.goal_poses = [ 
            {'x': 3819.09, 'y': 73720.7, 'zz': -0.968932, 'w': 0.247329},
            {'x': 3718.26, 'y': 73685.1, 'zz': 0.849285, 'w': 0.527935},
            {'x': 3800.65, 'y': 73764.3, 'zz': 0.243839, 'w': 0.969816}
        ] 
        self.publish_goal() 
